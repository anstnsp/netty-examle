...
/**
 * 네티로 구현한 API서버에서 가장 중요한 부분인채널 파이프라인 설정코드.
 */
public class ApiServerInitialzer extends ChannelInitializer<SocketChannel> {
    ...
    protected void initChannel(SocketChannel ch) throws Exception {
        ...
        pipeline.addLast(new ApiRequestParser()); //실제 FullHttpMessage 객체의 값을 확인하여 로직 처리 하는 곳.
